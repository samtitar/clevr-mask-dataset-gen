...
def set_layer(obj, layer_name):
    ...
    if layer_name not in bpy.context.scene.view_layers:
        bpy.context.scene.view_layers.new(name=layer_name)

    obj.hide_set(False, view_layer=bpy.context.scene.view_layers[layer_name])
...
def add_object(object_dir, name, scale, loc, theta=0):
    ...
    bpy.data.objects[new_name].rotation_euler[2] = theta
...
def load_materials(material_dir):
    ...
    for fn in os.listdir(material_dir):
        ...
        filepath = os.path.join(material_dir, fn)
